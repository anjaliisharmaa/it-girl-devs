        ...
        >
          ...
          <div className="border-l-4 border-pink-200 ml-12 lg:ml-16 min-h-full">
            ...
            <div className="pl-8 pr-12 pt-10 pb-12" style={{ lineHeight: '2.5rem' }}>
              ...
              <article 
                className="prose prose-pink prose-lg max-w-none [&_*]:!leading-[2.5rem] [&_p]:!my-0 [&_h1]:!mt-[5rem] [&_h1]:!mb-0 [&_h2]:!mt-[2.5rem] [&_h2]:!mb-0 [&_h3]:!mt-[2.5rem] [&_h3]:!mb-0 [&_h4]:!mt-[2.5rem] [&_h4]:!mb-0 [&_ul]:!my-0 [&_ol]:!my-0 [&_li]:!my-0 [&_div_h2]:!mt-0"
              >
