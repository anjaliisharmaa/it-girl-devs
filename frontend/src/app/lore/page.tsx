...
export default function LorePage() {
  return (
    <div className="min-h-screen bg-[#FFD1DC] text-[#590D22] pt-32 pb-0 px-4">
      {/* Journal Card Container */}
      <article className="max-w-3xl mx-auto bg-white/50 backdrop-blur-sm border border-white/60 rounded-[3rem] p-8 md:p-16 shadow-xl shadow-[#590D22]/5 mb-12">
        {/* Main Title */}
